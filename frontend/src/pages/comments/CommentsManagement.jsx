...
const CommentsManagement = () => {
  ...
  const handleBulkDelete = async (commentIds) => {
    if (window.confirm(`هل أنت متأكد من حذف ${commentIds.length} تعليق؟`)) {
      try {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-800">إدارة تعليقات فيسبوك</h1>
              <p className="text-slate-600 mt-1">إدارة والرد على تعليقات فيسبوك بسهولة</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <div className="text-blue-100 text-sm font-medium">الصفحة الحالية</div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <div className="text-emerald-100 text-sm font-medium">إجمالي عدد الصفحات</div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <div className="text-amber-100 text-sm font-medium">جميع التعليقات</div>
            </div>
          </div>
        </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-slate-200">
                  <thead className="bg-gradient-to-r from-slate-50 to-slate-100">
                    <tr>
                      <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">التعليق</th>
                      <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">المرسل</th>
                      <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">معرّف المنشور</th>
                      <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">التاريخ</th>
                      <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">الحالة</th>
                      ...
                      <tr>
                        <td colSpan="6" className="px-6 py-12 text-center">
                          <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-slate-500 text-lg font-medium">لا يوجد تعليقات</p>
                          </div>
                        </td>
                      </tr>
                    ) : (
                        ...
                        <tr key={comment.id} className="hover:bg-blue-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex gap-2 justify-end">
                              <button
                                onClick={() => {
                                  const response = prompt('اكتب ردك هنا:', comment.response || '');
                                  if (response !== null) {
                                    handleUpdateResponse(comment.id, response);
                                  }
                                }}
                                className="p-2 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors"
                                title={comment.respondedAt ? 'تعديل الرد' : 'رد'}
                              >
